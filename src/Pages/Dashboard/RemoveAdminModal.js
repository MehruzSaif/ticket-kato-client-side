...
const RemoveAdminModal = ({ removeAdmin, setRemoveAdmin, refetch }) => {
  ...
  const handleRemoveAdmin = () => {
    fetch(`https://ticket-kato.onrender.com/users/removeAdmin/${email}`, {
      method: "PUT",
      headers: {
      ...
      <div class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
          <h3 class="font-bold text-lg">
            Are you sure want to remove the user from Admin?
          </h3>
          <div class="modal-action">
            ...
            <label for="remove-admin-modal" class="btn px-6 btn-sm">
              Cancel
            </label>
          </div>
        </div>
