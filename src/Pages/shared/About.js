      ...
      {/* <div className="home mt-16">
        <div className="title">
          ...
          <div className="card-about">
            <h1>
              Welcome to <br />
              <span>Ticket Kato</span>
            </h1>

            <p>
              We are committed to deliver <span> The best service.</span> Our
              emloy have experience in working with clients.
            </p>
        ...
        <div class="container px-6 py-10 mx-auto">
          ...
          <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3  border-gray-700">
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl border-gray-700 border-1 shadow-lg">
              <img
                class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300"
                src="https://media-exp1.licdn.com/dms/image/C5603AQErwn6ebPXfPA/profile-displayphoto-shrink_800_800/0/1649586842746?e=1667433600&v=beta&t=-2pNaC42gTlBLOamB8s55YnxuaySGdBmcLeVPpHTp8E"
                alt=""
              />
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl border-gray-700 border-1 shadow-lg">
              ...
              <p class="mt-2 text-gray-500 capitalize ">UI/UX Specialist</p>
